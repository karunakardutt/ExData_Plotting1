...
## Histogram to PNG file plot3

# get the range for the x and y axis 
xrange <- range(D$DateTime) 
yrange <- range(D$Sub_metering_1) 

png(file="plot3.png", height=480, width=480)
plot(xrange, yrange, type="n", xlab="", ylab= "Energy sub metering") 
lines(D$DateTime, D$Sub_metering_1, lty=1, col="black")
lines(D$DateTime, D$Sub_metering_2, lty=1, col="red")
lines(D$DateTime, D$Sub_metering_3, lty=1, col="blue")
dev.off()
